...
router.post('/defaultCheckIn', ensureAuth, bootcampController.getDefaultCheckIn)
router.post('/defaultCheckInSubmit', upload.array('photos', 3), bootcampController.postDefaultCheckIn)
router.post('/defaultCheckInReview', ensureAuth, bootcampController.postDefaultCheckInReview)
...
router.get('/createSecondA', bootcampController.createSecondCheckInAcneMed)
router.get('/createAdmin', authController.createAdmin)
router.get('/test2', updateCheckIns, bootcampController.getAboutPage)
router.get('/createFirst', ensureAuth, bootcampController.initializeFirstCheckIn)
